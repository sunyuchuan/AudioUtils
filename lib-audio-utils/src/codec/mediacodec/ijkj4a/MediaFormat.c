...
void J4AC_android_media_MediaFormat__setString(JNIEnv *env, jobject thiz, jstring name, jstring value)
{
    (*env)->CallVoidMethod(env, thiz, class_J4AC_android_media_MediaFormat.method_setString, name, value);
}

void J4AC_android_media_MediaFormat__setString__catchAll(JNIEnv *env, jobject thiz, jstring name, jstring value)
{
    J4AC_android_media_MediaFormat__setString(env, thiz, name, value);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_android_media_MediaFormat__setString__withCString(JNIEnv *env, jobject thiz, const char *name_cstr__, const char *value_cstr__)
{
    jstring name = NULL;
    jstring value = NULL;
...
void J4AC_android_media_MediaFormat__setString__withCString__catchAll(JNIEnv *env, jobject thiz, const char *name_cstr__, const char *value_cstr__)
{
    jstring name = NULL;
    jstring value = NULL;
    ...
    J4AC_android_media_MediaFormat__setString__catchAll(env, thiz, name, value);
...
int J4A_loadClass__J4AC_android_media_MediaFormat(JNIEnv *env)
{
    ...
    class_J4AC_android_media_MediaFormat.method_setString = J4A_GetMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_MediaFormat.method_setString == NULL)
        goto fail;
