...
typedef struct SDL_AMediaFormat
{
    ...
    void (*func_setString)(SDL_AMediaFormat* aformat, const char* name, const char *value);
...
void SDL_AMediaFormat_setString(SDL_AMediaFormat* aformat, const char* name, const char *value);
