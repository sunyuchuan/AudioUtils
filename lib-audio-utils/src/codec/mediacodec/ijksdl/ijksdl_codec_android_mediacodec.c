...
ssize_t SDL_AMediaCodec_readOutputData(SDL_AMediaCodec* acodec, size_t idx, uint8_t **data)
{
    assert(acodec->func_readOutputData);
    return acodec->func_readOutputData(acodec, idx, data);
}
